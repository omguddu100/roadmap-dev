...
export class DashboardComponent implements OnInit {
  ...
  quotes = [
    { text: "First, solve the problem. Then, write the code.", author: "John Johnson", title: "Software Architect & Author" },
    { text: "Simplicity is prerequisite for reliability.", author: "Edsger W. Dijkstra", title: "Turing Award Winner" },
    { text: "Make it work, make it right, make it fast.", author: "Kent Beck", title: "Creator of Extreme Programming" },
    { text: "Code is like humor. When you have to explain it, it’s bad.", author: "Cory House", title: "Software Educator" }
  ];
  ...
  roadmaps = [
  {
    ...
    description: 'Master core JavaScript mechanics including scope, closures, execution context, prototypes, and asynchronous patterns.',
  ...
  },
  {
    ...
    description: 'Go from beginner to interview-ready with comprehensive coverage of JavaScript syntax, DOM manipulation, APIs, testing, and modern tooling.',
  ...
  },
  {
    ...
    description: 'Master Angular, RxJS, Signals, state management, and modern frontend architecture to build production-grade Web Apps.',
